                ...
                <form method="POST">
                    ...
                    <?php } else { ?>
                        <div class="alert alert-warning text-center">
                            Pilih role terlebih dahulu dari halaman utama
                        </div>
                    <?php } ?>
                    ...
                    <div class="d-grid gap-3">
                        ...
                        <?php } elseif ($roleDipilih == "guru") { ?>
                            <span class="text-center fs-6">
                                Belum punya akun?
                                <a href="register_guru.php" class="fw-semibold text-decoration-none">
                                    Daftar sebagai Guru
                                </a>
                            </span>
                        <?php } ?>
